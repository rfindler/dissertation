...
Benchmark of @secref["sec:benchmark"]
The benchmark is set of models,
each of which has a soundness property and a number
of different buggy variants.
...
24 hours@note{With one exception: I ran the derivation
...
this model. Thus there are 7 bugs that the derivation generator
...
of the two generation methods, the same data is plotted slightly
...
@citet[palka-diss]'s generator as is reffered to as ``hand-written.'' It takes
