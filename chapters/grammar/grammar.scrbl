...
are simple in the sense that they have no contextual
constraints, unlike richer
...
expression generation. First, I explain an approach
based on recursively unfolding non-terminals, introduced to
Redex by @citet[sfp2009-kf]. Following that I
